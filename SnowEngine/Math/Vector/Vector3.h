 ...
 *	\file
 *	\~english
 *	\brief The file with `Vector3` class
 *	
 *	This file contains the definition of the `Vector3` class.
 *	
 *	\~russian
 *	\brief Файл с классом `Vector3`
 *	
 ...
 *
 *	Этот класс используется для работы с трёхмерными векторами.
 */
...
public:
	...
	*/
	 ...
	 *	the squared length, you should use the `length_sq` method, which is more effective and
	 *	fast.
