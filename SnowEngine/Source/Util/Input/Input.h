...
public:
	 ...
	 *	
	 *	Creates the string `Input object`.
	 *	\return Created string.
	 *	
	 *	\~russian
	 *	\brief Конвертирует диспетчер ввода в строку
	 *	
	 *	Создаёт строку `Input object`.
	...
	/**
	 *	\~english
	 *	\brief Hash code of the input manager
	 *
	 *	Hash code is an integer number. Hash codes of two equal object are equal, but two different
	 *	objects can also have the same hash codes. The hash code of the input manager is always
	 *	zero.
	 *	\return Hash code of the object.
	 *
	 *	\~russian
	 *	\brief Хеш-код диспетчера ввода
	 *
	 *	Хеш-код — это целое число. Хеш-коды двух равных объектов равны, но два различных объекта
	 *	также могут иметь одинаковые хеш-коды. Хеш-код диспетчера ввода — всегда ноль.
