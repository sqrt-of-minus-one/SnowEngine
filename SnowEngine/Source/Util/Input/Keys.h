 ...
 *	\file
 *	\~english
 *	\brief The file with keys and buttons list
 *	
 *	This file contains enumerations of keyboard keys and mouse buttons.
 *	
 *	\~russian
 *	\brief Файл со списком клавиш и кнопок
 *	
 *	Этот файл содержит перечисления клавиш клавиатуры и кнопок мыши.
 */
