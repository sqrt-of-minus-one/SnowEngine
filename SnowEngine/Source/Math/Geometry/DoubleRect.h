...
public:
	...
	*/
	 ...
	 */
	DoubleRect(const Point2& position, const Vector2& size);
	 ...
	 */
	const Vector2& get_size() const noexcept;
	 ...
	 */
	DoubleRect& operator=(const DoubleRect& rect) noexcept;
	 ...
	 */
	bool operator==(const DoubleRect& rect) const noexcept;
