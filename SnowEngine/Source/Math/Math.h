 ...
 *	\param angle Аргумент арксинуса.
 ...
 *	\param angle Аргумент арккосинуса.
 ...
 *	\param angle Аргумент арксеканса.
 ...
 *	`SNOW_USE_STD_MATH`, используются стандартные функции из `std::`.
 *	\param angle Аргумент арккосеканса.
 ...
 *	\param angle Аргумент арктангенса.
 ...
 *	`SNOW_USE_STD_MATH`, используются стандартные функции из `std::`.
 *	\param angle Аргумент арккотангенса.
